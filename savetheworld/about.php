            ...
            <div class="container px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">In the face of environmental threats, communities unite globally for action. Let's transcend barriers, embrace sustainability, and ensure a harmonious future for all.</p>
                        <div class="row g-3">
