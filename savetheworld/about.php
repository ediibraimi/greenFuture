...
<body>
    <div class="container-fluid bg-white p-0" style="max-width: 100% !important;">
        <!-- Spinner Start -->
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title position-relative mb-4 pb-4">
                            <h1 class="mb-2">Welcome to GreenFuture</h1>
                        </div>
                        <p class="mb-4">GreenFuture is a group that cares about the face of environmental threats, communities unite globally for action. Let's transcend barriers, embrace sustainability, and ensure a harmonious future for all.</p>
                        <div class="row g-3">
                            ...
                            <div class="col-sm-4 wow fadeIn" data-wow-delay="0.3s">
                                <div class="bg-light rounded text-center p-4">
                                    ...
                                    <h2 class="mb-1" data-toggle="counter-up">1574</h2>
                            ...
                            <div class="col-sm-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="bg-light rounded text-center p-4">
                                    ...
                                    <h2 class="mb-1" data-toggle="counter-up">1899</h2>
                    ...
                    <div class="col-lg-5">
                        <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="tree2.png">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid py-5">
            <div class="container px-lg-5">
                <div class="section-title position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p class="mb-1">  We are a group of activists  who care about protecting the nature. We are three activists from North Macedonia in Tetovo.</p>
                </div>
                <div class="row g-4">
